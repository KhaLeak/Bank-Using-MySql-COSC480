...
// // Example routes using Sequelize
...
//     if (existingUser) {
//       res.send('<success>Username is already used.</success>');
//     } else {
...
//       });
//       res.send('<success>You are registered,You can login now.</success>');
//     }
//   } catch (error) {
//     console.error('Error signing up:', error);
//     res.status(500).send('<success>Internal Server Error</success>');
//   }
// });
...
//     if (!user) {
//       res.send('<success>Invalid username or password</success>');
//     } else {
